...
$stalePhrases = @(
    ...
    "Scuplting your mind",
    "Biological friction causes excuses",
    "2.comparison",
...
Write-Host "=== MINDSET CLUSTER QA REPORT ===" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "LEGEND: WC=word count, FAQ=faq questions found, Tbl=comparison table present"
